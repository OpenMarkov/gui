...
public class PotentialsTablePanelTest {
	...
	/**
	 * test to verify the getColumnsIdsSpreadSheetStyle method
	 */
	//@SuppressWarnings("deprecation")
	@Test
	public void testGetColumnsIdsSpreadSheetStyle () {

	    String[] columnIds = null;
	    int numColumns = 0;
	    columnIds = ValuesTable.getColumnsIdsSpreadSheetStyle( numColumns);
		...
		/*numColumns = 702;
	    columnIds = NodePotentialTable.getColumnsIdsSpreadSheetStyle( numColumns);
