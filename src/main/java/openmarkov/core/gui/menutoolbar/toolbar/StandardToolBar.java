package openmarkov.core.gui.menutoolbar.toolbar;
...
public class StandardToolBar extends ToolBarBasic implements ZoomMenuToolBar {
	...
	private JButton getNewNetworkButton() {
		...
		if (newNetworkButton == null) {
			...
			newNetworkButton.setIcon(iconLoader
	...
	private JButton getCloseNetworkButton() {
		...
		if (closeNetworkButton == null) {
			...
			closeNetworkButton.setIcon(iconLoader
	...
	private JButton getZoomInButton() {
		...
		if (zoomInButton == null) {
			...
			zoomInButton.setIcon(iconLoader
	...
	private JButton getZoomOutButton() {
		...
		if (zoomOutButton == null) {
			...
			zoomOutButton.setIcon(iconLoader
