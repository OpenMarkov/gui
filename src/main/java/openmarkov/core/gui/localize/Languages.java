package openmarkov.core.gui.localize;
...
public class Languages {
	 ...
	 */
	private static ArrayList<String> shortLocale = null;
	...
	/**
	 * This method adds all the languages supported by OPENMARKOV TODO read from an
	...
	public static String getString(String element) {
		...
		if (stringResource == null) {
			stringResource =
				StringResourceLoader.getUniqueInstance().getBundleLanguages();
		}
		if (element.equals("")) {
			return element;
		} else {
			try {
				return stringResource.getString(element
					+ ".LongName.Text.Label");
	 ...
	 * 
	 * @param index
	 *            element of the list of language.
	 ...
	 * 
	 * @param element
	 *            name of the language to search.
	 ...
	 * 
	 * @param index
	 *            element of the short name list of language.
	...
	public static String getShortNameByIndex(int index) {
		...
		try {
			return stringResource.getString(shortLocale.get(index)
				+ ".ShortName.Text.Label");
		} catch (IndexOutOfBoundsException e) {
			return null;
		}
	...
	/**
	 * reset the stringResource to force to take the new language
	 */
	public static void resetStringResource() {
