package openmarkov.core.gui.dialog.node;
...
import openmarkov.core.gui.dialog.common.PrefixedKeyTablePanel;
					...
					.addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.TRAILING)
						...
						.addGroup(groupLayout.createSequentialGroup()
							.addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.TRAILING, false)
								...
								.addComponent(getJLabelValuesPanel(), GroupLayout.Alignment.LEADING, GroupLayout.DEFAULT_SIZE, 54, Short.MAX_VALUE))
							.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
			...
			groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
				.addGroup(groupLayout.createSequentialGroup()
					...
					.addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.BASELINE)
						...
						.addComponent(getJComboBoxStatesValues(), GroupLayout.PREFERRED_SIZE, 23, GroupLayout.PREFERRED_SIZE))
					.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
					.addGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
	...
	protected void subItemStateChanged(ItemEvent e) {
		...
		if (e.getItemSelectable().equals(jComboBoxStatesValues)) {
			if (e.getStateChange() == ItemEvent.SELECTED) {
				states =
					DefaultStates.getByIndex(jComboBoxStatesValues
						.getSelectedIndex());
				translateStates(states);
				prefixedKeyTablePanelNodeStatesValues
					.setData(convertStringsToTableFormat(states));
			}
		}
	...
	public boolean checkStates() {
		...
		if (l == 0) {
			JOptionPane.showMessageDialog(
				this, messageStringResource
					.getString("EmptyStateList.Text.Label"),
				messageStringResource.getString("EmptyStateList.Title.Label"),
		...
		while (this.isValidDataInPanel() && (i < l)) {
			if ((data[i][0] == null) || data[i][0].equals("")) {
				JOptionPane.showMessageDialog(
					this, messageStringResource
						.getString("EmptyState.Text.Label"),
					messageStringResource.getString("EmptyState.Title.Label"),
					JOptionPane.ERROR_MESSAGE);
	            this.setValidDataInPanel(false);
				return false;
				...
				JOptionPane.showMessageDialog(
					this, messageStringResource
						.getString("DuplicatedState.Text.Label"),
					messageStringResource
						.getString("DuplicatedState.Title.Label"),
					JOptionPane.ERROR_MESSAGE);
	            this.setValidDataInPanel(false);
				return false;
			}
