...
public class KeyListSelectionDialog extends OkCancelHorizontalDialog {
	 ...
	 */
	public KeyListSelectionDialog(Window owner, String title,
									Object[][] newData, String[] newColumns) {
	...
	private JPanel getValuesTableScrollPane() {
		...
		if (valuesTableScrollPane == null) {
			...
			valuesTableScrollPane.add(
				getSubValuesTableScrollPane(), gridBagConstraints);
		}
	...
	private KeyTable getValuesTable() {
		...
		if (valuesTable == null) {
			...
			valuesTable.getSelectionModel().setSelectionMode(
