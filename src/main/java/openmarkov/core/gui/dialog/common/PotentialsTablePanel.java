...
import openmarkov.exceptions.IncompatibleEvidenceException;
import openmarkov.exceptions.InvalidStateException;
...
import openmarkov.gui.components.ValuesTable;
import openmarkov.gui.components.ValuesTableCellRenderer;
import openmarkov.gui.components.ValuesTableModel;
import openmarkov.gui.components.PotentialsTablePanelOperations;
import openmarkov.gui.dialogs.nodes.UncertainValuesDialog;
import openmarkov.gui.edit.UncertainValuesEdit;
import openmarkov.gui.edit.UncertainValuesRemoveEdit;
import openmarkov.gui.localize.StringResource;
import openmarkov.gui.localize.StringResourceLoader;
import openmarkov.gui.menutoolbar.common.ActionCommands;
import openmarkov.gui.menutoolbar.menu.PopupMenuFactory;
import openmarkov.gui.menutoolbar.menu.UncertaintyPopup;
import openmarkov.gui.networks.NodeProperties;
import openmarkov.gui.resources.icons.IconLoader;
import openmarkov.gui.utils.Util;
import openmarkov.networks.EvidenceCase;
import openmarkov.networks.Finding;
import openmarkov.networks.NodeType;
import openmarkov.networks.ProbNode;
import openmarkov.networks.State;
