package openmarkov.core.gui.dialog.about;
...
import openmarkov.core.gui.loader.element.ImageLoader;
...
//TODO to be consider to re-write as an standard dialog using the OpenMarkov dialog resource bundle
	/**
	 * default id 
	 */
	 ...
	 * 
	 * @param parent
	 *            the parent for the AboutBox frame
	 * @return anAboutBox dialog
	 */
	...
	private void jbInit() throws Exception {
		...
		product = dialogStringResource.getString("AboutBox.Product.Text");
		version = dialogStringResource.getString("AboutBox.Version.Text");
		copyright =
			dialogStringResource.getString("AboutBox.Copyright.Text");
		copyright2 =
			dialogStringResource.getString("AboutBox.Copyright.AllRightsReserved.Text");
		authors = dialogStringResource.getString("AboutBox.Authors.Text");
		advertisement =
			dialogStringResource.getString("AboutBox.Advertisement.Text");
		trademark =
			dialogStringResource.getString("AboutBox.Trademark.Text");
		openMarkovLogoImage = dialogStringResource.getString("AboutBox.OpenMarkovLogoImage.URL");
		lineSeparatorImage = dialogStringResource.getString("AboutBox.LineSeparatorImage.URL");
		...
		try {
			...
			jLabelLogo.setText(dialogStringResource
				.getString("AboutBox.jLabelLogo.BlankSpace.Text"));
			...
			jButtonOK.setText(dialogStringResource.getString("AboutBox.OK.Text"));
	...
	public void actionPerformed(ActionEvent actionEvent) {
		...
		if (actionEvent.getActionCommand().equals(
			dialogStringResource.getString("AboutBox.OK.Text"))) {
