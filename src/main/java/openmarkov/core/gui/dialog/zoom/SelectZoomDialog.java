package openmarkov.core.gui.dialog.zoom;
...
import openmarkov.core.gui.dialog.common.OkCancelHorizontalDialog;
...
public class SelectZoomDialog extends OkCancelHorizontalDialog {
	...
	private void initialize() {
		...
		setSize(300, 300);
		setTitle(stringResource.getString("SelectZoom.Title.Label"));
	...
	private JPanel getContentsPanel() {
		...
		if (contentsPanel == null) {
			...
			contentsPanel.setBorder(BorderFactory.createTitledBorder(
				null, stringResource.getString("ZoomValues.Title.Label"),
	...
	private JRadioButton getZoomOther() {
		...
		if (zoomOther == null) {
			...
			zoomOther.setText(stringResource.getString("ZoomOther.Text.Label"));
			zoomOther.setMnemonic(stringResource.getString(
				"ZoomOther.Text.Mnemonic").charAt(0));
	...
	private JSpinner getZoomSpinner() {
		...
		if (zoomSpinner == null) {
			...
			zoomSpinner.setModel(new SpinnerNumberModel((int) Math
				.round(Zoom.DEFAULT_VALUE * 100), (int) Math
				.round(Zoom.MIN_VALUE * 100), (int) Math
				.round(Zoom.MAX_VALUE * 100), 1));
		}
	 ...
	 * 
	 * @param defaultZoom
	 *            zoom that is selected as default.
