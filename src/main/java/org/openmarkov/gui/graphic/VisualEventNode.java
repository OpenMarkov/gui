...
//	private static final Color TERMINAL_BACKGROUND_COLOR =	new Color (230, 126, 0);
	...
	private static final Color FOREGROUND_COLOR = OpenMarkovPreferences
			.getColor(OpenMarkovPreferences.NODEEVENT_FOREGROUND_COLOR, OpenMarkovPreferences.OPENMARKOV_COLORS,
					Color.BLACK);
	...
	private static final Color TEXT_FOREGROUND_COLOR = OpenMarkovPreferences
			.getColor(OpenMarkovPreferences.NODEEVENT_TEXT_COLOR, OpenMarkovPreferences.OPENMARKOV_COLORS,
					Color.BLACK);
