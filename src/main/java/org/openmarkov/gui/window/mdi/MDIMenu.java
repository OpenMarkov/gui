...
public class MDIMenu extends Component {
	 ...
	 */
	public static final String WINDOW_MINIMIZEALL_MENUITEM = WINDOW_MENU + ".MinimizeAll";
	/**
	 * Constant that defines the item 'Window - RestoreAll'.
	 */
	public static final String WINDOW_RESTOREALL_MENUITEM = WINDOW_MENU + ".RestoreAll";
	/**
	 * Constant that defines the item 'Window - Cascade'.
	 */
	public static final String WINDOW_CASCADE_MENUITEM = WINDOW_MENU + ".Cascade";
	/**
	 ...
	 */
	public static final String WINDOW_PREVIOUS_MENUITEM = WINDOW_MENU + ".Previous";
	/**
	...
	private JMenuItem getWindowMinimizeAllMenuItem() {
		if (windowMinimizeAllMenuItem == null) {
			...
			windowMinimizeAllMenuItem.setText(stringDatabase.getString(WINDOW_MINIMIZEALL_MENUITEM + ".Label"));
			windowMinimizeAllMenuItem
					.setMnemonic(stringDatabase.getString(WINDOW_MINIMIZEALL_MENUITEM + ".Mnemonic").charAt(0));
	...
	private JMenuItem getWindowRestoreAllMenuItem() {
		if (windowRestoreAllMenuItem == null) {
			...
			windowRestoreAllMenuItem.setText(stringDatabase.getString(WINDOW_RESTOREALL_MENUITEM + ".Label"));
			windowRestoreAllMenuItem
					.setMnemonic(stringDatabase.getString(WINDOW_RESTOREALL_MENUITEM + ".Mnemonic").charAt(0));
	...
	private JMenuItem getWindowCascadeMenuItem() {
		if (windowCascadeMenuItem == null) {
			...
			windowCascadeMenuItem.setText(stringDatabase.getString(WINDOW_CASCADE_MENUITEM + ".Label"));
			windowCascadeMenuItem
					.setMnemonic(stringDatabase.getString(WINDOW_CASCADE_MENUITEM + ".Mnemonic").charAt(0));
	...
	private JMenuItem getWindowMosaicMenuItem() {
		if (windowMosaicMenuItem == null) {
			...
			windowMosaicMenuItem.setText(stringDatabase.getString(WINDOW_MOSAIC_MENUITEM + ".Label"));
			windowMosaicMenuItem.setMnemonic(stringDatabase.getString(WINDOW_MOSAIC_MENUITEM + ".Mnemonic").charAt(0));
	...
	private JMenuItem getWindowPreviousMenuItem() {
		if (windowPreviousMenuItem == null) {
			...
			windowPreviousMenuItem.setText(stringDatabase.getString(WINDOW_PREVIOUS_MENUITEM + ".Label"));
			windowPreviousMenuItem
					.setMnemonic(stringDatabase.getString(WINDOW_PREVIOUS_MENUITEM + ".Mnemonic").charAt(0));
			...
			windowPreviousMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_A, InputEvent.CTRL_DOWN_MASK));
		}
	...
	private JMenuItem getWindowNextMenuItem() {
		if (windowNextMenuItem == null) {
			...
			windowNextMenuItem.setMnemonic(stringDatabase.getString(WINDOW_NEXT_MENUITEM + ".Mnemonic").charAt(0));
			...
			windowNextMenuItem.setAccelerator(KeyStroke.getKeyStroke(KeyEvent.VK_Q, InputEvent.CTRL_DOWN_MASK));
		}
