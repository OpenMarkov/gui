...
@SuppressWarnings("serial") @Toolbar(name = "ObjectOriented") public class OOToolBar extends ToolBarBasic
	...
	@Override public void mouseMoved(MouseEvent e) {
		if (e.getSource().equals(getInstanceCreationButton())) {
			getInstanceCreationButton().setToolTipText(StringDatabase.getUniqueInstance()
					.getString(ActionCommands.INSTANCE_CREATION + STRING_TOOLTIP_SUFFIX));
		}
	}
}
