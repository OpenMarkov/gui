 ...
 * @param modifiable
 */
public AugmentedValuesTable (Node node, ValuesTableModel tableModel, AugmentedTable augmentedTable, final boolean modifiable)
{
    super (node, tableModel, modifiable);
...
public void setValueAt ( Object newValue, int row, int col )
{
    ...
    if (oldValueString.equals (newValueString)) return;
    
  
    
    AugmentedPotentialValueEdit nodePotentialEdit = new AugmentedPotentialValueEdit (node,
                                                                                newValueString,
                                                                                row,
                                                                                col,
                                                                                priorityList,
...
protected boolean castValue (Object newValue)
{
   ...
   if (newValue instanceof Double) return true;
   return false;
}
...
public void undoEditHappened (UndoableEditEvent event)
{
    ...
    try
    {
        ...
        super.getModel ().setValueAt (editTable.getFunctionValues()[edit.getIndexSelected()],
                                      edit.getRowPosition(),
...
public boolean editCellAt (int row, int column, EventObject e)
{
    ...
    if( e instanceof MouseEvent ) System.err.println("CLICK COUNT"+((MouseEvent)e).getClickCount());
