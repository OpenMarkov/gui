 ...
 * @param isModified 
 * 	- initial value for the cells is dataModified
 * @see #dataModified 
 * revised--> not changed
 */
...
public void setValueAt (Object newValue, int row, int col)
{
    ...
    TablePotentialValueEdit nodePotentialEdit = new TablePotentialValueEdit (node,
                                                                                (Double) newValue,
                                                                                row,
                                                                                col,
                                                                                priorityList,
 ...
 * @param edit
 * carmenyago changed the use of Chance and Utility variables
 * @author carmenyago
 */
