...
public class ICIOptionsPanel extends JPanel {
				...
				groupLayout.createSequentialGroup().addContainerGap().addGroup(
						groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
								groupLayout.createSequentialGroup()
										.addComponent(getJPanelTpcOrCanonical(), GroupLayout.PREFERRED_SIZE, 196,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(getJPanelNetoOrCompound(), GroupLayout.PREFERRED_SIZE, 137,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(getJPanelProbabilityOrValue(), GroupLayout.PREFERRED_SIZE, 151,
												GroupLayout.PREFERRED_SIZE)
										.addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
										.addComponent(getJPanelAllOrIndependant(), GroupLayout.DEFAULT_SIZE, 174,
												Short.MAX_VALUE))).addContainerGap()));
		groupLayout.setVerticalGroup(groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
				groupLayout.createSequentialGroup().addContainerGap().addGroup(
						groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING).addGroup(
								groupLayout.createParallelGroup(GroupLayout.Alignment.LEADING)
										.addComponent(getJPanelAllOrIndependant(), GroupLayout.DEFAULT_SIZE, 58,
												Short.MAX_VALUE)
										.addComponent(getJPanelProbabilityOrValue(), GroupLayout.DEFAULT_SIZE, 58,
												Short.MAX_VALUE)
										.addComponent(getJPanelNetoOrCompound(), GroupLayout.DEFAULT_SIZE, 58,
												Short.MAX_VALUE)
										.addComponent(getJPanelTpcOrCanonical(), GroupLayout.DEFAULT_SIZE, 58,
												Short.MAX_VALUE))).addContainerGap()));
	...
	protected JPanel getJPanelTpcOrCanonical() {
		if (jPanelTpcOrCanonical == null) {
			...
			jPanelTpcOrCanonical.setBorder(new LineBorder(UIManager.getColor("List.dropLineColor"), 1, false));
	...
	public JRadioButton getJRadioButtonCanonical() {
		if (jRadioButtonCanonical == null) {
			...
			jRadioButtonCanonical
					.setText(stringDatabase.getString("NodeProbsValuesTablePanel.jRadioButtonCanonical.Text"));
	...
	protected JPanel getJPanelNetoOrCompound() {
		if (jPanelNetoOrCompound == null) {
			...
			jPanelNetoOrCompound.setBorder(new LineBorder(UIManager.getColor("List.dropLineColor"), 1, false));
	...
	protected JRadioButton getJRadioButtonCompound() {
		if (jRadioButtonCompound == null) {
			...
			jRadioButtonCompound
					.setText(stringDatabase.getString("NodeProbsValuesTablePanel.jRadioButtonCompound.Text"));
	...
	protected JPanel getJPanelProbabilityOrValue() {
		if (jPanelProbabilityOrValue == null) {
			...
			jPanelProbabilityOrValue.setBorder(new LineBorder(UIManager.getColor("List.dropLineColor"), 1, false));
	...
	protected JRadioButton getJRadioButtonProbabilities() {
		if (jRadioButtonProbabilities == null) {
			...
			jRadioButtonProbabilities
					.setText(stringDatabase.getString("NodeProbsValuesTablePanel.jRadioButtonProbabilities." + "Text"));
	...
	protected JPanel getJPanelAllOrIndependant() {
		if (jPanelAllOrIndependant == null) {
			...
			jPanelAllOrIndependant.setBorder(new LineBorder(UIManager.getColor("List.dropLineColor"), 1, false));
			jPanelAllOrIndependant.setName("jPanelAllOrIndependant");
	...
	protected JRadioButton getJRadioButtonIndependent() {
		if (jRadioButtonIndependent == null) {
			...
			jRadioButtonIndependent
					.setText(stringDatabase.getString("NodeProbsValuesTablePanel.jRadioButtonIndependant.Text"));
