...
/**
 * Old version of FunctionPotentialPanel; after spliting in general panel and functionPanel
 * 06/11/2023
 */
@SuppressWarnings("serial") @PotentialPanelPlugin(potentialType = "Function") public class FunctionPotentialPanelOld
	...
	public FunctionPotentialPanelOld(Node node) {
		super();
		initComponents();
		setData(node);
	}
