						...
						layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
								layout.createSequentialGroup().addGap(39, 39, 39).addGroup(
										layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
												.addComponent(chkSaveEvidence).addComponent(chkSavePlainNetwork)
												.addComponent(chkSavePolicies).addComponent(chkSaveClassesInFile)))
								.addGroup(layout.createSequentialGroup().addGap(77, 77, 77).addComponent(btnOk)))
						.addContainerGap(43, Short.MAX_VALUE)));
		layout.setVerticalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
				layout.createSequentialGroup().addGap(23, 23, 23).addComponent(chkSavePlainNetwork)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(chkSaveClassesInFile)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 7, Short.MAX_VALUE)
						.addComponent(chkSaveEvidence)
						.addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
						.addComponent(chkSavePolicies).addGap(15, 15, 15).addComponent(btnOk).addContainerGap()));

		pack();
	}// </editor-fold>//GEN-END:initComponents

	private void chkSavePlainNetworkActionPerformed(
			java.awt.event.ActionEvent evt) {//GEN-FIRST:event_chkSavePlainNetworkActionPerformed
