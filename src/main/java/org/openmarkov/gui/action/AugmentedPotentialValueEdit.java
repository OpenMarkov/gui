...
public class AugmentedPotentialValueEdit extends SimplePNEdit {
	/**
...
*/      
        ...
        if (distributionName.equals(oldUnivariateDistrPotential.getProbDensFunctionName())){
            ...
            Class<? extends ProbDensFunction> newDistributionClass= ProbDensFunctionManager.getUniqueInstance().getProbDensFunctionClass(distributionName);
            newUnivariateDistrPotential= new UnivariateDistrPotential(oldPotential.getVariables(),newDistributionClass, oldPotential.getPotentialRole());
        }   
        newPotential=newUnivariateDistrPotential;
