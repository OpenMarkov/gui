...
public class MenuItemNames
{
     ...
     */
    public static final String EDIT_MARKASINPUT_MENUITEM =
        EDIT_MENU + ".MarkAsInput";
    /**
     * Constant that defines the item 'Edit - Instance Input'.
     */
    ...
    public static final String COSTEFFECTIVENESSSENSITIVITY_MENUITEM = TOOLS_MENU + ".CostEffectivenessSensitivity";
      ...
      */
     public static final String SENSITIVITYANALYSISDETERMINISTIC_MENUITEM = TOOLS_MENU + ".SensitivityAnalysisDeterministic";

     /**
      * Constant that defines the item 'Tools - Sensitivity Analysis - Probabilistic'.
      */
     public static final String SENSITIVITYANALYSISPROBABILISTIC_MENUITEM = TOOLS_MENU + ".SensitivityAnalysisProbabilistic";
