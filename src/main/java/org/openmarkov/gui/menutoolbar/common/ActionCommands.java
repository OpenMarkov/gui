...
public class ActionCommands {
	 ...
	 * Action invoked when the user wants to obtain the optimal interventions.
	 */
	public static final String COST_EFFECTIVENESS_SENSITIVITY = "Tools.CostEffectivenessSensitivity";
	/**
	 * Action invoked for Deterministic Sensitivity Analysis.
	 */
	public static final String SENSITIVITY_ANALYSIS_DETERMINISTIC = "Tools.SensitivityAnalysisDeterministic";
	/**
