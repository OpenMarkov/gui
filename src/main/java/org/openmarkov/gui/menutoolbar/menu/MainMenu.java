...
public class MainMenu extends JMenuBar implements MenuToolBarBasic, ZoomMenuToolBar {
	...
	private JMenuItem getFileNewMenuItem() {
		...
		if (fileNewMenuItem == null) {
			fileNewMenuItem = new LocalizedMenuItem(MenuItemNames.FILE_NEW_MENUITEM, ActionCommands.NEW_NETWORK,
	...
	private JMenuItem getFileOpenMenuItem() {
		...
		if (fileOpenMenuItem == null) {
			fileOpenMenuItem = new LocalizedMenuItem(MenuItemNames.FILE_OPEN_MENUITEM, ActionCommands.OPEN_NETWORK,
	...
	private JMenuItem getFileSaveMenuItem() {
		...
		if (fileSaveMenuItem == null) {
			fileSaveMenuItem = new LocalizedMenuItem(MenuItemNames.FILE_SAVE_MENUITEM, ActionCommands.SAVE_NETWORK,
	...
	private JMenuItem getFileSaveOpenMenuItem() {
		...
		if (fileSaveOpenMenuItem == null) {
			fileSaveOpenMenuItem = new LocalizedMenuItem(MenuItemNames.FILE_SAVE_OPEN_MENUITEM,
					ActionCommands.SAVE_OPEN_NETWORK, IconLoader.ICON_SAVE_ENABLED,
	...
	private JMenuItem getFileCloseMenuItem() {
		...
		if (fileCloseMenuItem == null) {
			fileCloseMenuItem = new LocalizedMenuItem(MenuItemNames.FILE_CLOSE_MENUITEM, ActionCommands.CLOSE_NETWORK,
	...
	private JMenuItem getFileExitMenuItem() {
		...
		if (fileExitMenuItem == null) {
			fileExitMenuItem = new LocalizedMenuItem(MenuItemNames.FILE_EXIT_MENUITEM, ActionCommands.EXIT_APPLICATION);
	...
	private JMenuItem getEditCutMenuItem() {
		...
		if (editCutMenuItem == null) {
			editCutMenuItem = new LocalizedMenuItem(MenuItemNames.EDIT_CUT_MENUITEM, ActionCommands.CLIPBOARD_CUT,
	...
	private JMenuItem getEditCopyMenuItem() {
		...
		if (editCopyMenuItem == null) {
			editCopyMenuItem = new LocalizedMenuItem(MenuItemNames.EDIT_COPY_MENUITEM, ActionCommands.CLIPBOARD_COPY,
	...
	private JMenuItem getEditPasteMenuItem() {
		...
		if (editPasteMenuItem == null) {
			editPasteMenuItem = new LocalizedMenuItem(MenuItemNames.EDIT_PASTE_MENUITEM, ActionCommands.CLIPBOARD_PASTE,
	...
	private JMenuItem getEditRemoveMenuItem() {
		...
		if (editRemoveMenuItem == null) {
			editRemoveMenuItem = new LocalizedMenuItem(MenuItemNames.EDIT_REMOVE_MENUITEM,
					ActionCommands.OBJECT_REMOVAL, IconLoader.ICON_REMOVE_ENABLED,
	...
	private JMenuItem getEditUndoMenuItem() {
		...
		if (editUndoMenuItem == null) {
			editUndoMenuItem = new LocalizedMenuItem(MenuItemNames.EDIT_UNDO_MENUITEM, ActionCommands.UNDO,
	...
	private JMenuItem getEditRedoMenuItem() {
		...
		if (editRedoMenuItem == null) {
			editRedoMenuItem = new LocalizedMenuItem(MenuItemNames.EDIT_REDO_MENUITEM, ActionCommands.REDO,
	...
	private JCheckBoxMenuItem getEditObjectSelectionMenuItem() {
		...
		if (editObjectSelectionMenuItem == null) {
			editObjectSelectionMenuItem = new LocalizedCheckBoxMenuItem(MenuItemNames.EDIT_MODE_SELECTION_MENUITEM,
					ActionCommands.OBJECT_SELECTION, IconLoader.ICON_SELECTION_ENABLED);
	...
	private JCheckBoxMenuItem getEditChanceCreationMenuItem() {
		...
		if (editChanceCreationMenuItem == null) {
			editChanceCreationMenuItem = new LocalizedCheckBoxMenuItem(MenuItemNames.EDIT_MODE_CHANCE_MENUITEM,
					ActionCommands.CHANCE_CREATION, IconLoader.ICON_CHANCE_ENABLED);
	...
	private JCheckBoxMenuItem getEditDecisionCreationMenuItem() {
		...
		if (editDecisionCreationMenuItem == null) {
			editDecisionCreationMenuItem = new LocalizedCheckBoxMenuItem(MenuItemNames.EDIT_MODE_DECISION_MENUITEM,
					ActionCommands.DECISION_CREATION, IconLoader.ICON_DECISION_ENABLED);
	...
	private JCheckBoxMenuItem getEditUtilityCreationMenuItem() {
		...
		if (editUtilityCreationMenuItem == null) {
			editUtilityCreationMenuItem = new LocalizedCheckBoxMenuItem(MenuItemNames.EDIT_MODE_UTILITY_MENUITEM,
					ActionCommands.UTILITY_CREATION, IconLoader.ICON_UTILITY_ENABLED);
	...
	private JCheckBoxMenuItem getEditLinkCreationMenuItem() {
		...
		if (editLinkCreationMenuItem == null) {
			editLinkCreationMenuItem = new LocalizedCheckBoxMenuItem(MenuItemNames.EDIT_MODE_LINK_MENUITEM,
					ActionCommands.LINK_CREATION, IconLoader.ICON_LINK_ENABLED);
	...
	private JMenuItem getTestMenuItem() {
		...
		if (editTestMenuItem == null) {
			editTestMenuItem = new LocalizedMenuItem(MenuItemNames.EDIT_NODETEST_MENUITEM, ActionCommands.TEST);
	...
	private JMenuItem getEditSwitchToInferenceModeMenuItem() {
		if (editSwitchToInferenceModeMenuItem == null) {
			editSwitchToInferenceModeMenuItem = new LocalizedMenuItem(
					MenuItemNames.EDIT_SWITCH_TO_INFERENCE_MODE_MENUITEM, ActionCommands.CHANGE_TO_INFERENCE_MODE,
	...
	private JMenuItem getInferenceSwitchToEditionModeMenuItem() {
		if (inferenceSwitchToEditionModeMenuItem == null) {
			inferenceSwitchToEditionModeMenuItem = new LocalizedMenuItem(
					MenuItemNames.INFERENCE_SWITCH_TO_EDITION_MODE_MENUITEM, ActionCommands.CHANGE_TO_EDITION_MODE,
	...
	private JMenuItem getPropagationOptionsMenuItem() {
		if (propagationOptionsMenuItem == null) {
			propagationOptionsMenuItem = new LocalizedMenuItem(MenuItemNames.PROPAGATION_OPTIONS_MENUITEM,
					ActionCommands.PROPAGATION_OPTIONS);
	...
	private JMenuItem getInferenceCreateNewEvidenceCaseMenuItem() {
		if (inferenceCreateNewEvidenceCaseMenuItem == null) {
			inferenceCreateNewEvidenceCaseMenuItem = new LocalizedMenuItem(
					MenuItemNames.INFERENCE_CREATE_NEW_EVIDENCE_CASE_MENUITEM, ActionCommands.CREATE_NEW_EVIDENCE_CASE,
	...
	private JMenuItem getInferenceGoToFirstEvidenceCaseMenuItem() {
		if (inferenceGoToFirstEvidenceCaseMenuItem == null) {
			inferenceGoToFirstEvidenceCaseMenuItem = new LocalizedMenuItem(
					...
					ActionCommands.GO_TO_FIRST_EVIDENCE_CASE, IconLoader.ICON_GO_TO_FIRST_EVIDENCE_CASE_ENABLED);
	...
	private JMenuItem getInferenceGoToPreviousEvidenceCaseMenuItem() {
		if (inferenceGoToPreviousEvidenceCaseMenuItem == null) {
			inferenceGoToPreviousEvidenceCaseMenuItem = new LocalizedMenuItem(
					...
					ActionCommands.GO_TO_PREVIOUS_EVIDENCE_CASE, IconLoader.ICON_GO_TO_PREVIOUS_EVIDENCE_CASE_ENABLED);
	...
	private JMenuItem getInferenceGoToNextEvidenceCaseMenuItem() {
		if (inferenceGoToNextEvidenceCaseMenuItem == null) {
			inferenceGoToNextEvidenceCaseMenuItem = new LocalizedMenuItem(
					MenuItemNames.INFERENCE_GO_TO_NEXT_EVIDENCE_CASE_MENUITEM, ActionCommands.GO_TO_NEXT_EVIDENCE_CASE,
	...
	private JMenuItem getInferenceGoToLastEvidenceCaseMenuItem() {
		if (inferenceGoToLastEvidenceCaseMenuItem == null) {
			inferenceGoToLastEvidenceCaseMenuItem = new LocalizedMenuItem(
					MenuItemNames.INFERENCE_GO_TO_LAST_EVIDENCE_CASE_MENUITEM, ActionCommands.GO_TO_LAST_EVIDENCE_CASE,
	...
	private JMenuItem getInferenceClearOutAllEvidenceCasesMenuItem() {
		if (inferenceClearEvidenceCasesMenuItem == null) {
			inferenceClearEvidenceCasesMenuItem = new LocalizedMenuItem(
					...
					ActionCommands.CLEAR_OUT_ALL_EVIDENCE_CASES, IconLoader.ICON_CLEAR_OUT_ALL_EVIDENCE_CASES_ENABLED);
	...
	private JMenuItem getInferencePropagateEvidenceMenuItem() {
		if (inferencePropagateEvidenceMenuItem == null) {
			inferencePropagateEvidenceMenuItem = new LocalizedMenuItem(
					MenuItemNames.INFERENCE_PROPAGATE_EVIDENCE_MENUITEM, ActionCommands.PROPAGATE_EVIDENCE,
	...
	private JMenuItem getInferenceRemoveAllFindingsMenuItem() {
		if (inferenceRemoveAllFindingsMenuItem == null) {
			inferenceRemoveAllFindingsMenuItem = new LocalizedMenuItem(
					MenuItemNames.INFERENCE_REMOVE_ALL_FINDINGS_MENUITEM, ActionCommands.NODE_REMOVE_ALL_FINDINGS);
	...
	private JMenuItem getViewZoomInMenuItem() {
		...
		if (viewZoomInMenuItem == null) {
			viewZoomInMenuItem = new LocalizedMenuItem(MenuItemNames.VIEW_ZOOM_IN_MENUITEM, ActionCommands.ZOOM_IN,
	...
	private JMenuItem getViewZoomOutMenuItem() {
		...
		if (viewZoomOutMenuItem == null) {
			viewZoomOutMenuItem = new LocalizedMenuItem(MenuItemNames.VIEW_ZOOM_OUT_MENUITEM, ActionCommands.ZOOM_OUT,
	...
	private JCheckBoxMenuItem getViewZoomOtherMenuItem() {
		...
		if (viewZoomOtherMenuItem == null) {
			viewZoomOtherMenuItem = new LocalizedCheckBoxMenuItem(MenuItemNames.VIEW_ZOOM_OTHER_MENUITEM,
					ActionCommands.ZOOM_OTHER, true);
	...
	private JMenuItem getHelpOpenAboutItem() {
		...
		if (helpOpenAboutMenuItem == null) {
			helpOpenAboutMenuItem = new LocalizedMenuItem(MenuItemNames.HELP_ABOUT_MENUITEM, ActionCommands.HELP_ABOUT);
