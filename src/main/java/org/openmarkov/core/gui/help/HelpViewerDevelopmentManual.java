package org.openmarkov.core.gui.help;
...
public class HelpViewerDevelopmentManual extends javax.swing.JFrame {
	...
	private HelpViewerDevelopmentManual() {
		this.theHelpSet = myHelpSet();
	  	...
	  	this.logger = Logger.getLogger(HelpViewerDevelopmentManual.class);
	}
	...
	public static HelpSet myHelpSet() {
		...
		try {
			URL hsURL = HelpSet.findHelpSet(HelpViewerDevelopmentManual.class.getClassLoader(), aHelpSet);
			URL realHsURL = hsURL;
	...
	private static JMenuItem helpMenuItem() {
		...
		ActionListener helper =
			new CSH.DisplayHelpFromSource(helpViewer.getHb());
