 ...
 * 
 */
package org.openmarkov.core.gui.utils;
...
public class OpenMarkovPreferences implements OpenMarkovPreferencesKeys {
	...
	public static Preferences OPENMARKOV_DIRECTORIES =
		OPENMARKOV_PREFERENCES.node( "directories" );
	public static Preferences OPENMARKOV_POSITIONS =
		OPENMARKOV_PREFERENCES.node( "positions" );
	public static Preferences OPENMARKOV_COLORS =
	 ...
	 * 
	 * @param key -
	 *            the key to get the preference
	 * @param defaultValue -
	 *            a default value to set if no key is found
	 ...
	 *            the key to get the preference
	 * @param preferences -
	 *            the preferences node to look for
	 ...
	 * 
	 * @param key -
	 *            the key to access the preference
	 * @param value -
	 *            the string value to set the preference
	 * @param preferences -
	 *            the preference node to look for
	 */
	 ...
	 *            the key to access the preference
	 * @param value -
	 *            the boolean value to set the preference
	 * @param preferences -
	 *            the preference node to look for
	 */
	 ...
	 *            the key to access the preference
	 * @param value -
	 *            the int value to set the preference
	 * @param preferences -
	 *            the preference node to look for
	 */
	...
	public static void setDefaultPreferences() {
		...
		set(
			PREFERENCE_LANGUAGE, System.getProperty( "user.language" ),
	...
	public static void setDefaultColors() {
		...
		setColor( OpenMarkovPreferences.NODECHANCE_BACKGROUND_COLOR, //def
			new Color (251,249,153), //cream color			before it was --> //new Color( 235, 245, 35 ), //one type of yellow
		...
		setColor( OpenMarkovPreferences.NODEDECISION_BACKGROUND_COLOR, //def
			new Color (207,227,253 ), //light blue color		before it was --> //new Color( 25, 255, 255 ), // gray color
			OpenMarkovPreferences.OPENMARKOV_COLORS );
		...
		setColor( OpenMarkovPreferences.NODEUTILITY_BACKGROUND_COLOR, //def
			new Color ( 208,230,178), //light green color		before it was --> //new Color( 0, 125, 0 ), //green color
			OpenMarkovPreferences.OPENMARKOV_COLORS );
		setColor( OpenMarkovPreferences.NODEUTILITY_FOREGROUND_COLOR, //def
			Color.BLACK, //black color
			OpenMarkovPreferences.OPENMARKOV_COLORS );
		setColor( OpenMarkovPreferences.NODEUTILITY_TEXT_COLOR, //def
				new Color( 0, 0, 0 ), //black color							before it was --> //new Color( 230, 230, 230 ), //one dark green color 
			OpenMarkovPreferences.OPENMARKOV_COLORS );
