...
/**
 * This variable is used to display or not the column header. Visible by default
 */
	 ...
	 *            modifiable.
	 */
	public KeyTable(TableModel dm, boolean newModifiable
	 ...
	 */
	public KeyTable(TableModel dm, boolean newModifiable
	                ,boolean firstColumnHidden, boolean showColumnHeader
	                ) {
	...
	public TableCellEditor getCellEditor(int row, int column) {
		...
		return (!modifiable || (column == 0)) ? null : super.getCellEditor(
			row, column);
