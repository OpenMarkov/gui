...
public class StringWordTokenizer implements WordTokenizer {
	...
	public StringWordTokenizer(String text) {
		...
		// Wrap a string buffer to hopefully make things a bit easier and
		// efficient to
		// replace words etc.
	...
	/**
	 * This method can be used to return the final text after the schecking is
	 * complete.
	 */
	...
	public static void main(String args[]) {
		...
		t =
			new StringWordTokenizer(
				"This is a acronym (A.C.M.E). This is the second sentance.");
		while (t.hasMoreWords()) {
			String word = t.nextWord();
			System.out.println("Word is '" + word + "'. Starts Sentance?="
				+ t.isNewSentance());
