/*
 * GNU Lesser General Public License PropertiesDialog Copyright (C) 2003 Frits
 * Jalvingh, Jerry Pommer & Howard Kistler This library is free software; you
...
public class ExtendedHTMLDocument extends HTMLDocument {
	 ...
	 * 
	 * @param e
	 *            Element bei dem die Attribute ge�ndert werden sollen
	 * @param a
	 *            AttributeSet mit den neuen Attributen
	 * @param tag
	 *            Angabe was f�r ein Tag das Element ist
	 */
		...
		if ((e != null) && (a != null)) {
			try {
				...
				DefaultDocumentEvent changes =
					new DefaultDocumentEvent(start, e.getEndOffset() - start,
	...
	public void removeElements(Element e, int index, int count)
		...
		try {
			...
			DefaultDocumentEvent dde =
				new DefaultDocumentEvent(start, end - start,
