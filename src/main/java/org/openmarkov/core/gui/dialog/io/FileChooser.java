...
public class FileChooser extends JFileChooser {
	...
	/**
	 * OpenMarkov files filter
	 */
	private FileFilterBasic elviraFilter, openMarkovXmlFilter;


	/**
	 * OpenMarkov files filter ( pgmx extension )
	 */
	private FileFilterPGMX openMarkovPgmxFilter;

	private FileFilterXLS openMarkovXLSFilter;
   ...
   public FileChooser() {
	...
	public void setExcelFilter() {
		...
		setFileFilter(openMarkovXLSFilter);

	}

	/**
	 * Sets the filter to search only xml files.
	 */
	public void setXMLFilter() {

		setFileFilter(openMarkovXmlFilter);

	}
	/**
	 * Sets the filter to search only xml files.
	 */
	public void setPGMXFilter() {

		setFileFilter(openMarkovPgmxFilter);
		...
		if (getDialogType() == SAVE_DIALOG) {
			if (getSelectedFile().exists()) {
				if (JOptionPane.showConfirmDialog(
					...
					stringResource.getString("OverwriteNetwork.Title.Label"),
			...
			JOptionPane.showMessageDialog(
				this, getSelectedFile().getName() + " "
					+ stringResource.getString("FileNotExists.Text.Label"),
	...
	private void setTextsInLocale() {
		...
		UIManager.put("FileChooser.cancelButtonText", rb
		...
		UIManager.put("FileChooser.detailsViewActionLabelText", rb
			.getString("FileChooser.detailsViewActionLabelText"));
		UIManager.put("FileChooser.detailsViewButtonToolTipText", rb
			.getString("FileChooser.detailsViewButtonToolTipText"));
		UIManager.put("FileChooser.fileNameLabelText", rb
			.getString("FileChooser.fileNameLabelText"));
		UIManager.put("FileChooser.filesOfTypeLabelText", rb
			.getString("FileChooser.filesOfTypeLabelText"));
		UIManager.put("FileChooser.helpButtonText", rb
		...
		UIManager.put("FileChooser.listViewActionLabelText", rb
			.getString("FileChooser.listViewActionLabelText"));
		UIManager.put("FileChooser.listViewButtonToolTipTextlist", rb
			.getString("FileChooser.newFolderToolTipText"));
		UIManager.put("FileChooser.lookInLabelText", rb
			.getString("FileChooser.lookInLabelText"));
		UIManager.put("FileChooser.newFolderActionLabelText", rb
			.getString("FileChooser.newFolderActionLabelText"));
		UIManager.put("FileChooser.newFolderToolTipText", rb
			.getString("FileChooser.newFolderToolTipText"));
		UIManager.put("FileChooser.openButtonTextOpen", rb
			.getString("FileChooser.openButtonTextOpen"));
		UIManager.put("FileChooser.openButtonToolTipText", rb
			.getString("FileChooser.openButtonToolTipText"));
		UIManager.put("FileChooser.refreshActionLabelText", rb
			.getString("FileChooser.refreshActionLabelText"));
		UIManager.put("FileChooser.saveButtonTextSave", rb
			.getString("FileChooser.saveButtonTextSave"));
		UIManager.put("FileChooser.saveButtonToolTipText", rb
			.getString("FileChooser.saveButtonToolTipText"));
		UIManager.put("FileChooser.upFolderToolTipText", rb
			.getString("FileChooser.upFolderToolTipText"));
		UIManager.put("FileChooser.updateButtonText", rb
			.getString("FileChooser.updateButtonText"));
		UIManager.put("FileChooser.updateButtonToolTipText", rb
			.getString("FileChooser.updateButtonToolTipText"));
		UIManager.put("FileChooser.viewMenuLabelText", rb
			.getString("FileChooser.viewMenuLabelText"));
