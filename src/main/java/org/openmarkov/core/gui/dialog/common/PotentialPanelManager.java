...
public class PotentialPanelManager
{
        ...
        public PotentialPanelManager ()
        {
            ...
            for (Class<?> plugin : findAllPotentials ())
            {
                ...
                {
                    potentialPanels.put (lAnnotation.potentialType (), (Class<? extends PotentialPanel>)plugin);
                }
                else
                {
        ...
        public final PotentialPanel getPotentialPanel (String potentialType, ProbNode probNode)
        {
            ...
            try
            {
                instance = (PotentialPanel) potentialPanels.get (potentialType).getConstructor (ProbNode.class) .newInstance (probNode);
            }
            catch (Exception e)
            {
            ...
            if(instance == null)
            {
                instance = new EmptyPotentialPanel ();
            }
            return instance;
        }
