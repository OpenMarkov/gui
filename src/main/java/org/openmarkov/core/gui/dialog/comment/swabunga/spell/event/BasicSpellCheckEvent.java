...
class BasicSpellCheckEvent implements SpellCheckEvent {
	 ...
	 * 
	 * @param String
	 *            invalidWord The word that is misspelt
	 * @param List
	 *            suggestions A list of Word objects that are suggested to
	 *            replace the currently mispelt word
	 * @param WordTokenizer
	 *            tokenizer The reference to the tokenizer that caused this
	 *            event to fire.
	 */
	 ...
	 * @param boolean
	 *            replaceAll If set to true, the SpellChecker will replace all
	 *            further occurances of the misspelt word without firing a
	 *            SpellCheckEvent.
	 */
	 ...
	 * 
	 * @param boolean
	 *            ignoreAll If set to true, the SpellChecker will replace all
	 *            further occurances of the misspelt word without firing a
	 *            SpellCheckEvent.
	 */
