...
public class CostEffectivenessAnalysis
{
     ...
     * @return
     */
    public List<Intervention> getFrontierInterventions (List<Intervention> allInterventions)
    {
    ...
    /**
     * @param frontierInterventions. <code>ArrayList</code> of
     *            <code>Intervention</code>
     * @return Interventions with incremental CE ratio. <code>ArrayList</code>
     *         of <code>Intervention</code>
     */
    public List<Intervention> calculateICERsOfFrontier (List<Intervention> frontierInterventions)
    {
