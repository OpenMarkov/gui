/*
 * GNU Lesser General Public License UserInputDialog Copyright (C) 2000 Howard
...
public class UserInputDialog extends JDialog {
	...
	public UserInputDialog(Frame parent, String title, boolean bModal,
							String attribName, String defaultText) {
