...
public class VisualUtilityNode extends VisualNode {
	...
	OpenMarkovPreferences.getColor(OpenMarkovPreferences.NODEUTILITY_BACKGROUND_COLOR, 
	...
	OpenMarkovPreferences.getColor(OpenMarkovPreferences.NODEUTILITY_FOREGROUND_COLOR, 
	                             OpenMarkovPreferences.OPENMARKOV_COLORS,
	                             Color.BLACK);
	...
	OpenMarkovPreferences.getColor(OpenMarkovPreferences.NODEUTILITY_TEXT_COLOR, 
	                             OpenMarkovPreferences.OPENMARKOV_COLORS,
	                             Color.BLACK);
	...
	private Point2D.Double[] getPoints(Graphics2D g) {
		...
		if (isExpanded()) {
			...
			hexagonWidth = NODE_EXPANDED_WIDTH + 8.0; //...asaez................................valor antiguo 6.0
		} else {
	...
	public Point2D.Double cutPoint(Segment segment, Graphics2D g) {
		...
		while ((result == null) && (iteration < length)) {
			result =
				segment.cutPoint(new Segment(points[index1], points[index2]));
