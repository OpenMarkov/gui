...
public class VisualDecisionNode extends VisualNode {
	...
	OpenMarkovPreferences.getColor(OpenMarkovPreferences.NODEDECISION_FOREGROUND_COLOR, 
	                             OpenMarkovPreferences.OPENMARKOV_COLORS,
	                             Color.BLACK);
	...
	OpenMarkovPreferences.getColor(OpenMarkovPreferences.NODEDECISION_TEXT_COLOR, 
	                             OpenMarkovPreferences.OPENMARKOV_COLORS,
	                             Color.BLACK);
	...
	public Shape getShape(Graphics2D g) {
		...
		return new Rectangle2D.Double(rectanglePosX, rectanglePosY,
