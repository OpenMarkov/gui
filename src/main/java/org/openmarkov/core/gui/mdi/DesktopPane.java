...
public class DesktopPane extends JDesktopPane {
	 ...
	 * 
	 * @param frame
	 *            frame to be minimized.
	 * @throws UnsupportedOperationException
	 *             if iconification is vetoed.
	 */
	private void minimize(JInternalFrame frame)
		...
		if (!frame.isIcon()) {
			try {
				...
				throw new UnsupportedOperationException(stringResource
					.getString("IconificationVetoed.Text.Label"));
			}
		}
	...
	private void restore(JInternalFrame frame)
		...
		if (frame.isIcon()) {
			try {
				...
				throw new UnsupportedOperationException(stringResource
					.getString("RestorationVetoed.Text.Label"));
			}
		}
	 ...
	 * 
	 * @param frame
	 *            internal frame that will be selected.
	 * @throws UnsupportedOperationException
	 ...
	 * 
	 * @param panel
	 *            panel that is the content panel of the internal frame that
	 *            will be selected.
	 * @throws UnsupportedOperationException
	 *             if the selection is vetoed.
	 */
	public void selectFrame(JPanel panel) throws UnsupportedOperationException {
