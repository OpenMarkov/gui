        ...
        PNUndoableEditListener
{
    ...
    public boolean[][] getDataModified ()
    {
        ...
        {
            dataModified = new boolean[getTableModel ().getRowCount ()][getTableModel ().getColumnCount ()];// adding
                                                                                                            // one
                                                                                                            // column
                                                                                                            // for
                                                                                                            // leak
    ...
    private void auxUndoableEditHappenedUncertainValuesEdit (UndoableEditEvent arg0)
    {
        boolean isChance;
        int row;
    ...
    public void auxUndoableEditHappenedNodePotentialEdit (UndoableEditEvent arg0)
    {
        ...
        switch (edit.getProbNode ().getNodeType ())
        {
            ...
            case CHANCE :
                ...
                TablePotential auxPotential = DiscretePotentialOperations.reorder (tablePotential,
                                                                                   newOrderVariables);
